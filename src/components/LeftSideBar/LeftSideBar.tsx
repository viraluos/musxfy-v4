...
export default function LeftSideBar() {
    ...
    return (
        <aside className="sticky top-0 z-10 lg:h-screen w-full flex items-center justify-between lg:flex-col lg:items-start lg:justify-start lg:w-64 p-6 bg-gradient-to-r lg:bg-gradient-to-b from-gray-800 via-gray-900 to-gray-900">
            <div>
